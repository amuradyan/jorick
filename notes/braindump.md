...
The langchain/anthropic api did not play well with params and Opus 4.7 so we ditched it in favor of THE anthropic api directly. No langchain in Jorick atm.

## On first test results
